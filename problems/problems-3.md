...
We write $\Gamma \vdash^\ast \varphi$ to indicate that $\varphi$ is derivable from $\Gamma$ in the new system.
...
2. The Deduction Theorem for $\vdash^\ast$: For all $\Gamma$ and $\varphi$ and $\psi$:
