...
::: {.example-panel}
Let $A = \{a, b\}$ and $R = \{\langle a, b \rangle, \langle b, c\rangle, \langle a, c\rangle\}$. Then $R$ is transitive on $W$.
:::
...
::: {.example-panel}
If $A$ is the set of undergraduate students at USC and we let $R$ be $\{\langle x, y\rangle: x \ \text{is in the same year as} \ y\}$, then if
