...
format:
  revealjs:
    theme: [default, theme.scss, examples.scss]
...
The terms *symmetric*, *reflexive*, and *euclidean* refer to specific features of binary relations, and we will discuss them next.

## Reading

- Modal Logic. [Introduction](https://gabriel-uzquiano.github.io/modal-logic/intro.html). 

Next: 

- Modal Logic. [Background](https://gabriel-uzquiano.github.io/modal-logic/background.html).
